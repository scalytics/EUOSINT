...
export interface AgentOpsConsumerGroupMember {
  member_id: string;
  client_id: string;
  client_host: string;
  instance_id?: string;
...
export interface AgentOpsConsumerGroup {
  group_id: string;
  state: string;
  protocol_type: string;
  protocol: string;
  members: AgentOpsConsumerGroupMember[];
}

export interface AgentOpsOperatorState {
  supported: boolean;
  live_group_id?: string;
  replay_group_ids: string[];
  groups: AgentOpsConsumerGroup[];
  last_error?: string;
}

export interface AgentOpsFusionMatch {
  alert_id: string;
  title: string;
  category: string;
  severity: string;
