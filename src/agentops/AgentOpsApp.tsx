...
import type { AgentOpsMessage, AgentOpsMode, AgentOpsState } from "@/types/agentops";
...
export function AgentOpsApp({ state, mode }: Props) {
...
function MetricCard({ icon: Icon, label, value, hint }: { icon: typeof Workflow; label: string; value: string; hint: string }) {
  return (
...
function Panel({ title, icon: Icon, children }: { title: string; icon: typeof Workflow; children: ReactNode }) {
  return (
...
function MessageCard({ message }: { message: AgentOpsMessage }) {
  return (
